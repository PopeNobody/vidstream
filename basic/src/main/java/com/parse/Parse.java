...
import com.parse.offline.ParsePinningEventuallyQueue;
...
public class Parse {
  ...
  static void initialize(Configuration configuration, ParsePlugins parsePlugins) {
    ...
    if (configuration.localDataStoreEnabled) {
      ...
      ParseKeyValueCache.initialize(configuration.context.getCacheDir());
    }
...
//  }
  ...
  private static ParseEventuallyQueue getEventuallyQueue(Context context) {
    synchronized (MUTEX) {
      ...
      if (eventuallyQueue == null || (isLocalDatastoreEnabled && eventuallyQueue instanceof ParseCommandCache) ||
          (!isLocalDatastoreEnabled && eventuallyQueue instanceof ParsePinningEventuallyQueue))
      {
        ...
        eventuallyQueue = isLocalDatastoreEnabled ? new ParsePinningEventuallyQueue(context, httpClient) :
  ...
  public static final class Configuration {
    ...
    private Configuration(Builder builder) {
      ...
      this.pushPath = builder.pushPath;
    }
    ...
    public static final class Builder {
      ...
      /**
       * Set the path to use for pushes.  You can set it to /functions/push, for example,
       * and instead of sending a push directly, it will call your cloud code function.
       * <p>
       *
       * @param pushPath the path to use for pushes.  Normally /push
       * @return The same builder, for easy chaining.
       */
