...
//import com.parse.push.ParsePush;
//import com.parse.boltsinternal.Task;
//import com.parse.rest.ParseRESTCommand;
//import com.parse.rest.ParseRESTPushCommand;
//
...
//  }
//
//  ParseRESTCommand buildRESTSendPushCommand(
//      ParsePush.State state, String sessionToken
//  )
//  {
//    return ParseRESTPushCommand.sendPushCommand(state.queryState(), state.channelSet(), state.expirationTime(),
//                                                state.expirationTimeInterval(), state.pushTime(), state.data(),
//                                                sessionToken);
//  }
//}
//
