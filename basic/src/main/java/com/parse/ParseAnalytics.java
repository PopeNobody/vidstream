...
import com.parse.controller.ParseAnalyticsController;
...
public class ParseAnalytics {
  ...
  public static Task<Void> trackAppOpenedInBackground(Intent intent) {
    String pushHashStr = null;//getPushHashFromIntent(intent);
  ...
  )
  {
    ...
    final Map<String, String> dimensionsCopy = dimensions != null ?
                                               Collections.unmodifiableMap(new HashMap<>(dimensions)) : null;
...
//      PLog.e(TAG, "Failed to com.parse push data: " + e.getMessage());
//    }
//    return pushHash;
//  }
}
