...
public class JSONObject {
     ...
     * be skipped.
     */
    public JSONObject(@NonNull JSONObject copyFrom, @NonNull String[] names) throws
                                                                                       JSONException
    {
        this();
     ...
     * @return this object.
     */
    @NonNull public JSONObject put(@NonNull String name, @Nullable Object value) throws
                                                                                 JSONException
    {
        if (value == null) {
     ...
     */
    @NonNull public JSONObject putOpt(@Nullable String name, @Nullable Object value) throws
                                                                                     JSONException
    {
    ...
    // unhidden.
    @NonNull public JSONObject accumulate(@NonNull String name, @Nullable Object value) throws
                                                                                        JSONException
    {
