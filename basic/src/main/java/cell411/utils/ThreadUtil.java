...
public class ThreadUtil {
  static {
    synchronized (ThreadUtil.class) {
      waitUntil(ThreadUtil.class, () -> true);
    }
  }
  ...
  @SuppressWarnings("SynchronizationOnLocalVariableOrMethodParameter") public static long wait(Object o, long timeout) {
  ...
  public static void wait(long time, boolean ignored) {
    try {
      Thread.currentThread()
            .wait(time);
    } catch (Exception e) {
      throw Util.rethrow("waiting", e);
    }
  }
