...
import com.parse.offline.ParseObjectStore;
import com.parse.offline.OfflineObjectStore;
  ...
  public ParseCurrentInstallationController getCurrentInstallationController() {
    if (currentInstallationController.get() == null) {
      ...
      ParseObjectStore<ParseInstallation> store = Parse.isLocalDatastoreEnabled() ?
                                                  new OfflineObjectStore<>(ParseInstallation.class,
                                                                           PIN_CURRENT_INSTALLATION, fileStore) :
                                                  fileStore;
      CachedCurrentInstallationController controller = new CachedCurrentInstallationController(store, ParsePlugins.get()
                                                                                                                  .installationId());
